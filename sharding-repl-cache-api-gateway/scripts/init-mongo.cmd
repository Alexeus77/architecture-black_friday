...
curl -i "http://localhost:9180/apisix/admin/upstreams/api_upstream" ^
-H "X-API-KEY: edd1c9f034335f136f87ad84b625c8f1" -X PUT -d "{ \"name\": \"Pymongo API Upstream\", \"type\": \"roundrobin\", \"nodes\": { \"pymongo_api_1:8080\": 1, \"pymongo_api_2:8080\": 1 } }"

curl -i "http://localhost:9180/apisix/admin/routes/api_route" ^
-H "X-API-KEY: edd1c9f034335f136f87ad84b625c8f1" -X PUT -d "{ \"uri\": \"/*\", \"upstream_id\": \"api_upstream\" }"